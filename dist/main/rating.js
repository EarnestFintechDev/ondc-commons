...
var RatingApi = /** @class */ (function () {
    ...
    ], RatingApi.prototype, "context", void 0);
    __decorate([
        postgres_backend_1.Documentation.addField({ type: "object", properties: {
                rating_category: { type: "string" },
                id: { type: "string" },
                value: { type: "number" },
                feedback_form: { type: "array", items: { $ref: postgres_backend_1.Documentation.getRef(feedbackForm_1.FeedbackForms) } },
                feedback_id: { type: "string" }
            } }),
        __metadata("design:type", Object)
    ], RatingApi.prototype, "message", void 0);

...
var Search = /** @class */ (function () {
    function Search(context, message) {
    ...
    __decorate([
        postgres_backend_1.Documentation.addField({ $ref: postgres_backend_1.Documentation.getRef(intent_1.Intent) }),
        __metadata("design:type", Object)
    ], Search.prototype, "message", void 0);
    Search = __decorate([

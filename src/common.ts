...
export type Offers = {
  ...
  descriptor: Descriptor;
  location_ids: string[];
  // [Location/properties/idstring]
  category_ids: string[];
  // [Category/properties/idstring
  // Unique id of the category
  item_ids: string[];
  // Item/properties/idstring
...
// ENUM
export enum usabilityType {
  "online" = "online", offline = "offline", both = "both"
}
export enum occasionType {
  BIRTHDAY = "BIRTHDAY", MARRIAGE = "MARRIAGE", FESTIVAL = "FESTIVAL", FRIENDSHIP = "FRIENDSHIP", OTHER = "OTHER"
}
export enum type {
  "CONSTANT",
  "VARIABLE",
...
export enum DeliveryType {
  "SMS" = "SMS", "EMAIL" = "EMAIL", SMS_EMAIL = "SMS_EMAIL", PHYSICAL = "PHYSICAL"
}
